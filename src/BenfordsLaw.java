...
public class BenfordsLaw extends Application {
    ...
    public static File name(Scanner user) {
        System.out.println("Input file name");  // Asking the user for the file name
        String fileName = user.nextLine();  // Storing user input as a string variable
        File file = new File(fileName); //  Turning that file name into a File variable
